...
public static class MoleBuilderExtensions
{
    ...
    {
        entity.ToTable("UserTokens", SystemConstants.Database.IdentitySchema)
    ...
    {
        entity.ToTable("UserLogins", SystemConstants.Database.IdentitySchema)
            .HasKey(x => x.UserId);
    ...
    {
        entity.ToTable("UserClaims", SystemConstants.Database.IdentitySchema)
            .HasKey(x => x.Id);
    ...
    {
        entity.ToTable("UserRoles", SystemConstants.Database.IdentitySchema)
    ...
    {
        entity.ToTable("Roles", SystemConstants.Database.IdentitySchema)
            .HasKey(x => x.Id);
    ...
    {
        entity.ToTable("Users", SystemConstants.Database.IdentitySchema)
            .HasKey(x => x.Id);
    ...
    {
        entity.ToTable("RoleClaims", SystemConstants.Database.IdentitySchema)
            .HasKey(x => x.Id);
